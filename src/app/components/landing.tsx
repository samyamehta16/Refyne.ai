    ...
    return (
        <div className="flex flex-col items-center min-h-screen bg-[#F4F6FF] text-black font-dm">
            ...
            <div className="hero flex flex-col items-center bg-[url('/assets/images/lbg.svg')] bg-center bg-cover bg-no-repeat min-h-[80vh] w-full relative pb-20">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    ...
                    <Link href={"/getstarted"}>
                        <button className="bg-[#5BB5EA] mt-12 p-4 text-[20px] rounded-md text-lg font-semibold hover:bg-[#5BB5EA] hover:bg-opacity-70">
                            Get Started
                        </button>
                    </Link>
                </div>
            ...
            <div className="text-center text-5xl">
                ...
                <div className="bg-white w-[1400px] rounded-xl shadow-lg m-12 z-10 flex flex-col p-12">
